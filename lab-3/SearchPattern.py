...
Task Description:
     ...
     Running Example:
     C:\INF1002\Lab3\PatternSearching>python3 SearchPattern.py 1,2,3,1,2 1,2
...
def SearchPattern():
     ...
     for i in range(candidate_length-pattern_length+1):
          ...
          for x in range(pattern_length):
               temp_list.append(candidate_list[i+x])
          
          if temp_list == pattern_list:
               same_count += 1
     
     print(f"Pattern appears {same_count} time!")

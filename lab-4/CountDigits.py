...
Running example:
      C:\INF1002\Lab4\CountDigits> python3 CountDigits.py 789
...
def CountDigits():
      num = int(sys.argv[1])
      print("The number of digit(s) calculated by recursive is ", digit_recursive(num), " and by iterative is ",digit_iterative(num),".")
